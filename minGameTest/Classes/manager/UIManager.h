...
namespace CCBI {
    ...
    static const std::string main_item = "main_item.ccbi";        
    static const std::string main_effect = "main_effect.ccbi";
    static const std::string main_touch = "main_touch.ccbi";
    
    
    
    static const std::string att_progress = "att_progress0.ccbi";
    static const std::string att_bing = "gj_bing.ccbi";
    static const std::string att_bing_behit = "gj_bing_beijizhong.ccbi";
    static const std::string st_dusu = "st_dusu.ccbi";//每回合少血
    static const std::string st_lvdu = "st_lvdu.ccbi";
    
    //
    //static const std::string eff_chaochenggong = "ui_chaochenggong.ccbi";
