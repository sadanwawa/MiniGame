...
#include "MainItemLayerLoader.h"
#include "MainEffectLayerLoader.h"
#include "ParticaleAttEffectLoader.h"
#include "ParticaleEffectLayerLoader.h"
#include "TouchTestLayerLoader.h"
...
{        
    ...
    ccNodeLoaderLibrary->registerNodeLoader("MainItemLayer", MainItemLayerLoader::loader());
    ccNodeLoaderLibrary->registerNodeLoader("MainEffectLayer", MainEffectLayerLoader::loader());
    //ccNodeLoaderLibrary->registerNodeLoader("ParticaleAttEffect", ParticaleAttEffectLoader::loader());
    ccNodeLoaderLibrary->registerNodeLoader("ParticaleEffectLayer", ParticaleEffectLayerLoader::loader());
    
    ccNodeLoaderLibrary->registerNodeLoader("TouchTestLayer", TouchTestLayerLoader::loader());
