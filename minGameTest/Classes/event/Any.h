...
#ifndef minGameTest_Any_h
#define minGameTest_Any_h
...
public: 
    ...
    ValueType operator()() const
    {
        if (!mContent) 
        {
           // throwException("Exception::ERR_INVALIDPARAMS, Bad cast from uninitialised Any, Any::operator()");
        }
        ...
        {
            //throwException("Exception::ERR_INVALIDPARAMS,Any::operator()");
        }
    }
...
ValueType any_cast(const Any & operand)
{
    ...
    if(!result)
    {
        //throwException("Exception::ERR_INVALIDPARAMS,Any::any_cast()");
    }
    return *result;
}
/** @} */
